...
<img src="./images/qc-process-management-univariate.png" width=500><br/>
...
<img src="./images/qc-process-management-multivariate.png" width=500><br/>


#### 手法例: 相関の崩れを検知する
<img src="./images/qc-process-management-correlation.png" width=500><br/>
...
<img src="./images/qc-factor-analysis.png" width=500><br/>

### 手法例: 線形回帰モデルを用いた多変数の解析
<img src="./images/qc-factor-analysis-rl.png" width=500><br/>

### 手法例: 決定木を用いた多変数の解析
<img src="./images/qc-factor-analysis-dt.png" width=500><br/>

### 手法例: ニューラルネットワークを用いた多変数の解析
<img src="./images/qc-factor-analysis-nn.png" width=500><br/>
